...
function initialize() {
  ...
  location7 = new locale(7,"Eastern Wall of room two","This doesn't look like the eastern wall from the other room. There is a fireplace here.", "none");
  
  location8 = new locale(8,"North Wall of room two","The north wall of this room is different than the last there is a picture of cake on the wall.", "none");
